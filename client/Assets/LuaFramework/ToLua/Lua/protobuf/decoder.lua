...
-- by kingbird 64位的解析返回到lua反正也有精度损失，tolua中源代码64位返回的是字符串，有性能损失，索性改成32位的，只要不超lua number精度即可正常工作
local _DecodeVarint32 = pb.varint_decoder
local _DecodeSignedVarint32 = pb.signed_varint_decoder

local _DecodeVarint64 = pb.varint_decoder
local _DecodeSignedVarint64 = pb.signed_varint_decoder
