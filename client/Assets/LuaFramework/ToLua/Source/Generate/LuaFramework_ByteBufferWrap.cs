...
public class LuaFramework_ByteBufferWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("ReadBase64Buffer", ReadBase64Buffer);
		L.RegFunction("WriteBase64Buffer", WriteBase64Buffer);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int ReadBase64Buffer(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			LuaFramework.ByteBuffer obj = (LuaFramework.ByteBuffer)ToLua.CheckObject(L, 1, typeof(LuaFramework.ByteBuffer));
			LuaInterface.LuaByteBuffer o = obj.ReadBase64Buffer();
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int WriteBase64Buffer(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
