...
public class UnityEngine_UI_AspectRatioFitterWrap
{
	...
	static int SetLayoutHorizontal(IntPtr L)
	{
		try
		{
			...
			UnityEngine.UI.AspectRatioFitter obj = (UnityEngine.UI.AspectRatioFitter)ToLua.CheckObject(L, 1, typeof(UnityEngine.UI.AspectRatioFitter));
	...
	static int get_aspectMode(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index aspectMode on a nil value" : e.Message);
		}
	}
