...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		RectWebViewWrap.Register(L);
		BatteryLevelWrap.Register(L);
		AvatarManagerWrap.Register(L);
		PushManagerWrap.Register(L);
		MirrortechRichTextWrap.Register(L);
		GameChooseRotationWrap.Register(L);
		PaymentManagerWrap.Register(L);
		AniEventHandlerWrap.Register(L);
		PageViewWrap.Register(L);
		ClosePopupOnBgWrap.Register(L);
		NotiConstWrap.Register(L);
		ClipBoardWrap.Register(L);
		pomeloBehaviourWrap.Register(L);
		ViewWrap.Register(L);
		BaseWrap.Register(L);
		...
		LuaFramework_VectorFunctionWrap.Register(L);
		LuaFramework_ConfForLuaWrap.Register(L);
		...
		L.RegFunction("Action_LitJson_JsonData", System_Action_LitJson_JsonData);
		L.EndModule();
		L.BeginModule("Pomelo");
		L.BeginModule("DotNetClient");
		Pomelo_DotNetClient_PomeloClientWrap.Register(L);
		Pomelo_DotNetClient_ServerTypeWrap.Register(L);
		Pomelo_DotNetClient_ClientProtocolTypeWrap.Register(L);
		L.EndModule();
		L.EndModule();
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int System_Action_LitJson_JsonData(IntPtr L)
	{
		try
		{
			LuaFunction func = ToLua.CheckLuaFunction(L, 1);
			Delegate arg1 = DelegateFactory.CreateDelegate(typeof(System.Action<LitJson.JsonData>), func);
			ToLua.Push(L, arg1);
			return 1;
		}
		catch(Exception e)
	...
	static int LitJson_WrapperFactory(IntPtr L)
	{
		...
		{
			LuaFunction func = ToLua.CheckLuaFunction(L, 1);
			Delegate arg1 = DelegateFactory.CreateDelegate(typeof(LitJson.WrapperFactory), func);
			ToLua.Push(L, arg1);
			return 1;
		}
		catch(Exception e)
