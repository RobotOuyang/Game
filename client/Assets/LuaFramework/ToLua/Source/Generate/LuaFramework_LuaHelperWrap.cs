...
public class LuaFramework_LuaHelperWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("GetAvatarManager", GetAvatarManager);
		L.RegFunction("GetPaymentManager", GetPaymentManager);
		L.RegFunction("GetResManager", GetResManager);
		L.RegFunction("GetNetManager", GetNetManager);
		L.RegFunction("GetPomeloBehaviour", GetPomeloBehaviour);
		L.RegFunction("GetSoundManager", GetSoundManager);
		L.RegFunction("GetGameManager", GetGameManager);
		L.RegFunction("GetPushManager", GetPushManager);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetAvatarManager(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 0);
			AvatarManager o = LuaFramework.LuaHelper.GetAvatarManager();
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetPaymentManager(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 0);
			PaymentManager o = LuaFramework.LuaHelper.GetPaymentManager();
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetPomeloBehaviour(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 0);
			pomeloBehaviour o = LuaFramework.LuaHelper.GetPomeloBehaviour();
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetPushManager(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 0);
			PushManager o = LuaFramework.LuaHelper.GetPushManager();
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
