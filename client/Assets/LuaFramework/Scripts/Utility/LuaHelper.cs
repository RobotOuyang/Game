...
namespace LuaFramework {
    public static class LuaHelper {
        ...
        {
            return AppFacade.Instance.GetManager<AvatarManager>(ManagerName.Avatar);
        }

        public static PaymentManager GetPaymentManager()
        {
            return AppFacade.Instance.GetManager<PaymentManager>(ManagerName.Payment);
        }
        /// <summary>
        /// 资源管理器
        /// </summary>
        ...
        public static pomeloBehaviour GetPomeloBehaviour() {
            return AppFacade.Instance.GetManager<pomeloBehaviour>(ManagerName.Pomelo);
        }
        ...
        {
            return AppFacade.Instance.GetManager<PushManager>(ManagerName.Push);
        }
